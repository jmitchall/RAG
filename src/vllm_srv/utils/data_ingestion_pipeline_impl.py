...
import os
from vllm_srv.ingestion.data_ingestion_pipeline import DataIngestionPipeline
...
if __name__ == "__main__":
    ...
    for collection_name in document_collections:
        ...
        files = [f for f in os.listdir(os.path.join(root_data_path, collection_name)) if os.path.isfile(os.path.join(root_data_path, collection_name, f))]
