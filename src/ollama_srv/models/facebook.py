...
def main():
    ...
    # For a model similar to facebook/opt-125m, use a small local model:
    model = "ollama/phi3"  # Phi-3 mini model via Ollama
    # model = "ollama/mistral"  # Mistral 7B via Ollama
    # model = "ollama/tinyllama"  # TinyLlama (very small, fast)
    ...
    # OPTION 4: HuggingFace model (similar to original facebook/opt-125m)
    # os.environ["HUGGINGFACE_API_KEY"] = "your-hf-token-here"
    # model = "huggingface/facebook/opt-125m"
