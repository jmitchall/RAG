...
locally on your computer or via cloud APIs. It's like having ChatGPT running on your own machine!
...
- For local models: Ollama or similar local LLM server
- For cloud models: API keys (OpenAI, Anthropic, etc.)
- For HuggingFace models: HuggingFace account and authentication
...
def main():
    ...
    # and can route to different models easily.

    # OPTION 1: Local Phi-3 model via Ollama (free, runs on your computer)
    model = "ollama/phi3"  # Phi-3 mini model via Ollama

    # OPTION 2: HuggingFace Phi-3 model (requires HuggingFace API key)
    # os.environ["HUGGINGFACE_API_KEY"] = "your-hf-token-here"
    # model = "huggingface/microsoft/Phi-3-mini-4k-instruct"

    # OPTION 3: OpenAI models (requires API key)
    # os.environ["OPENAI_API_KEY"] = "your-api-key-here"
    # model = "gpt-3.5-turbo"
    # model = "gpt-4"

    # OPTION 4: Anthropic Claude (requires API key)
    # os.environ["ANTHROPIC_API_KEY"] = "your-api-key-here"
    # model = "claude-3-sonnet-20240229"

    # OPTION 5: Azure OpenAI (requires Azure credentials)
    ...
    for prompt in prompts:
        ...
        # Store the response with the original prompt
        responses.append({
            "prompt": prompt,
